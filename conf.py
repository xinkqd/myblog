...
BLOG_AUTHOR = "MrX"  # (translatable)
BLOG_TITLE = "攻城狮小站"  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link. Don't forget the protocol (http/https)!
SITE_URL = "https://qianbi_tou.gitee.io/my_blog/"
# This is the URL where Nikola's output will be deployed.
# If not set, defaults to SITE_URL
# BASE_URL = "https://example.com/"
BLOG_EMAIL = "xinkqd#foxmail.com"
BLOG_DESCRIPTION = "记录自己的学习成长历程"  # (translatable)
...
# (translatable)
LICENSE = "本站作品采用知识共享署名-非商业性使用-相同方式共享 4.0 国际许可协议进行许可。"
